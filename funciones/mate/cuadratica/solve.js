...
function calcular(){
	...
	var solText = disc >= 0 ? 'X values = ( '+solucion.x1.toFixed(2) + ', ' + solucion.x2.toFixed(2) + ' )' : 'X values = ( '+solucion.x1 + 'i, ' + solucion.x2 + 'i )' 

	$('#discriminante').html('Discriminant = ' + disc.toFixed(2))
