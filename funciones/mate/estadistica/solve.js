...
function calcular(){
    ...
    $(".promedio").html("<b>Average: </b>" + promedio)
    
    $(".mediana").html("<b>Median: </b>" + mediana())

    $(".moda").html("<b>Mode: </b>" + moda(data))

    $(".varianza").html("<b>Variance: </b>" + varianza())

    $(".desviacionM").html("<b>Average Deviation: </b>" + desviacionMedia())

    $(".desviacionS").html("<b>Standard Deviation: </b>" + Math.sqrt(varianza()).toFixed(2))
}
