...
function convertirTiempo(entrada, unidadEntrada, unidadSalida){
...
function cambiarUnidades(value){
    ...
    switch(value){
        ...
        case 'data':
                ...
                <li><a class="topic black-text " href="#!" onclick="unidadE(kb, 'kb')">Kilobyte (KB)</a></li>
                ...
                <li><a class="topic black-text " href="#!" onclick="unidadS(kb, 'kb')">Kilobyte (KB)</a></li>
            ...
            case 'time':
                ...
                temp = false;
                $('#dropdownConversions').html(`
                <li><a class="topic black-text " href="#!" onclick="unidadE(year, 'yr')">Years</a></li>
                <li><a class="topic black-text " href="#!" onclick="unidadE(day, 'd')">Days</a></li>
                <li><a class="topic black-text " href="#!" onclick="unidadE(hour, 'hr')">Hours</a></li>
                <li><a class="topic black-text " href="#!" onclick="unidadE(min, 'min')">Minutes</a></li>
                <li><a class="topic black-text " href="#!" onclick="unidadE(second, 's')">Seconds</a></li>
                <li><a class="topic black-text " href="#!" onclick="unidadE(ms, 'ms')">Milisecond</a></li>
                ...
                $('#dropdownConversions2').html(`
                <li><a class="topic black-text " href="#!" onclick="unidadS(year, 'yr')">Years</a></li>
                <li><a class="topic black-text " href="#!" onclick="unidadS(day, 'd')">Days</a></li>
                <li><a class="topic black-text " href="#!" onclick="unidadS(hour, 'hr')">Hours</a></li>
                <li><a class="topic black-text " href="#!" onclick="unidadS(min, 'min')">Minutes</a></li>
                <li><a class="topic black-text " href="#!" onclick="unidadS(second, 's')">Seconds</a></li>
                <li><a class="topic black-text " href="#!" onclick="unidadS(ms, 'ms')">Milisecond</a></li>
            ...
            case 'deg':
                ...
                temp = false;
                $('#dropdownConversions').html(`
                <li><a class="topic black-text " href="#!" onclick="unidadE(deg, 'deg')">Degrees</a></li>
                <li><a class="topic black-text " href="#!" onclick="unidadE(rad, 'rad')">Radians</a></li>
                ...
                $('#dropdownConversions2').html(`
                <li><a class="topic black-text " href="#!" onclick="unidadS(deg, 'deg')">Degrees</a></li>
                <li><a class="topic black-text " href="#!" onclick="unidadS(rad, 'rad')">Radians</a></li>
    ...
    switch(value){
        case "area":
            ...
            $('#dropdownConversions').html(`
                ...
                <li><a class="topic white-text " href="#!" onclick="unidadE(area, 'a')">Area (a)</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadE(hectarea, 'ha')">Hectare (ha)</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadE(sqrcm, 'cm<sup>2</sup>')">Square Centimeter (cm<sup>2</sup>)</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadE(sqrft, 'ft<sup>2</sup>')">Square feet (ft<sup>2</sup>)</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadE(sqrin, 'in<sup>2</sup>')">Square inch (in<sup>2</sup>)</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadE(metro, 'm<sup>2</sup>')">Square meter (m<sup>2</sup>)</a></li>
            
            `)
    
            $('#dropdownConversions2').html(`
                <li><a class="topic white-text " href="#!" onclick="unidadE(acre, 'ac')">Acre (ac)</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadS(area, 'a')">Area (a)</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadS(hectarea, 'ha')">Hectare (ha)</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadS(sqrcm, 'cm<sup>2</sup>')">Square Centimeter (cm<sup>2</sup>)</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadS(sqrft, 'ft<sup>2</sup>')">Square feet (ft<sup>2</sup>)</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadS(sqrin, 'in<sup>2</sup>')">Square inch (in<sup>2</sup>)</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadS(metro, 'm<sup>2</sup>')">Square meter (m<sup>2</sup>)</a></li>
        ...
        case "length":
            ...
            temp = false;
            $('#dropdownConversions').html(`
            <li><a class="topic white-text " href="#!" onclick="unidadE(mm, 'mm')">Milimetre (mm)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(cm, 'cm')">Centimetre (cm)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(metro, 'm')">Metre (m)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(km, 'km')">Kilometre (km)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(pulgada, 'in')">Inch (in)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(pie, 'ft')">Feet (ft)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(yd, 'yd')">Yard (yd)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(milla, 'mi')">Mile (mi)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(millaN, 'NM')">Nautical mile (NM)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(mil, 'mil')">Mil (mil)</a></li>
            
            `)
    
            $('#dropdownConversions2').html(`
            <li><a class="topic white-text " href="#!" onclick="unidadS(mm, 'mm')">Milimetre (mm)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(cm, 'cm')">Centimetre (cm)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(metro, 'm')">Metre (m)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(km, 'km')">Kilometre (km)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(pulgada, 'in')">Inch (in)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(pie, 'ft')">Feet (ft)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(yd, 'yd')">Yard (yd)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(milla, 'mi')">Mile (mi)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(millaN, 'NM')">Nautical mile (NM)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(mil, 'mil')">Mil (mil)</a></li>
        ...
        case "volume":
            ...
            temp = false;
            $('#dropdownConversions').html(`
            <li><a class="topic white-text " href="#!" onclick="unidadE(galUK, 'Gal (UK)')">Gallon (UK) (Gal)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(galUS, 'Gal (US)')">Gallon (US) (Gal)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(litro, 'l')">Liter (l)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(ml, 'ml')">Mililiter (ml)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(cmCubico, 'cm<sup>3</sup>')">Cubic centimetre (cm<sup>3</sup>)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(metro, 'm<sup>3</sup>')">Cubic metre (m<sup>3</sup>)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(inCubica, 'in<sup>3</sup>')">Cubic inch (in<sup>3</sup>)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(pieCubico, 'ft<sup>3</sup>')">Cubic feet (ft<sup>3</sup>)</a></li>
            
            
            `)
    
            $('#dropdownConversions2').html(`
            <li><a class="topic white-text " href="#!" onclick="unidadS(galUK, 'Gal (UK)')">Gallon (UK) (Gal)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(galUS, 'Gal (US)')">Gallon (US) (Gal)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(litro, 'l')">Liter (l)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(ml, 'ml')">Mililiter (ml)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(cmCubico, 'cm<sup>3</sup>')">Cubic centimetre (cm<sup>3</sup>)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(metro, 'm<sup>3</sup>')">Cubic metre (m<sup>3</sup>)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(inCubica, 'in<sup>3</sup>')">Cubic inch (in<sup>3</sup>)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(pieCubico, 'ft<sup>3</sup>')">Cubic feet (ft<sup>3</sup>)</a></li>
            `)
        ...
        case 'mass':
            ...
            <li><a class="topic white-text " href="#!" onclick="unidadE(lb, 'lb')">Pound (lb)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(oz, 'oz')">Ounce (oz)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(kg, 'kg')">Kilogram (kg)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadE(g, 'g')">Gram (g)</a></li>
            ...
            $('#dropdownConversions2').html(`
            <li><a class="topic white-text " href="#!" onclick="unidadS(t, 't')">Ton (t)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(tUK, 't')">Ton (UK) (t)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(tUS, 't')">Ton (US) (t)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(lb, 'lb')">Pound (lb)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(oz, 'oz')">Ounce (oz)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(kg, 'kg')">Kilogram (kg)</a></li>
            <li><a class="topic white-text " href="#!" onclick="unidadS(g, 'g')">Gram (g)</a></li>
            `)
        ...
        case 'data':
                ...
                <li><a class="topic white-text " href="#!" onclick="unidadE(kb, 'kb')">Kilobyte (KB)</a></li>
                ...
                <li><a class="topic white-text " href="#!" onclick="unidadS(kb, 'kb')">Kilobyte (KB)</a></li>
            ...
            case 'time':
                ...
                temp = false;
                $('#dropdownConversions').html(`
                <li><a class="topic white-text " href="#!" onclick="unidadE(year, 'yr')">Years</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadE(day, 'd')">Days</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadE(hour, 'hr')">Hours</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadE(min, 'min')">Minutes</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadE(second, 's')">Seconds</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadE(ms, 'ms')">Milisecond</a></li>
                ...
                $('#dropdownConversions2').html(`
                <li><a class="topic white-text " href="#!" onclick="unidadS(year, 'yr')">Years</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadS(day, 'd')">Days</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadS(hour, 'hr')">Hours</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadS(min, 'min')">Minutes</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadS(second, 's')">Seconds</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadS(ms, 'ms')">Milisecond</a></li>
            ...
            case 'deg':
                ...
                temp = false;
                $('#dropdownConversions').html(`
                <li><a class="topic white-text " href="#!" onclick="unidadE(deg, 'deg')">Degrees</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadE(rad, 'rad')">Radians</a></li>
                ...
                $('#dropdownConversions2').html(`
                <li><a class="topic white-text " href="#!" onclick="unidadS(deg, 'deg')">Degrees</a></li>
                <li><a class="topic white-text " href="#!" onclick="unidadS(rad, 'rad')">Radians</a></li>
