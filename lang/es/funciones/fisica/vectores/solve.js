...
function calcular(){
	...
	if(fuerzas_x.length >=2){
		...
		x_forces.innerHTML = lang == "en" ? "X forces = " + total_x + " N" : "Fuerzas en X = " + total_x;

		y_forces.innerHTML = lang == "en" ? "Y forces = " + total_y + " N" : "Fuerzas en Y = " + total_y;

		resultado.innerHTML = lang == "en" ? "Resultant force = " + (Math.sqrt(result)).toFixed(2) + " N" : "Fuerza resultante = " + (Math.sqrt(result)).toFixed(2)+ " N";

		r_angle.innerHTML = lang == "en" ? "Resultant angle = " + (angle_r * (180/Math.PI)).toFixed(2) + "°": "Ángulo resultante = " + (angle_r * (180/Math.PI)).toFixed(2) + "°";
